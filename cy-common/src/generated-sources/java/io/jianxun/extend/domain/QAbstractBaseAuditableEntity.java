package io.jianxun.extend.domain;
...
public class QAbstractBaseAuditableEntity extends EntityPathBase<AbstractBaseAuditableEntity> {
    ...
    private static final long serialVersionUID = 681230558L;
    ...
    public final io.jianxun.extend.domain.business.QUser createdBy;
    ...
    public final io.jianxun.extend.domain.business.QUser lastModifieBy;
    ...
    public QAbstractBaseAuditableEntity(Class<? extends AbstractBaseAuditableEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.createdBy = inits.isInitialized("createdBy") ? new io.jianxun.extend.domain.business.QUser(forProperty("createdBy"), inits.get("createdBy")) : null;
        this.lastModifieBy = inits.isInitialized("lastModifieBy") ? new io.jianxun.extend.domain.business.QUser(forProperty("lastModifieBy"), inits.get("lastModifieBy")) : null;
    }
